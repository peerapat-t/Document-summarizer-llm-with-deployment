...
with tab4:
    ...
    # Upload file
    st.header("🌍 Upload WEBSITE file")

    web = st.sidebar.text_input('*Note: Enter only 1 website to upload, larger website will charges more credit.*', key='uploaded_file_4')
    st.markdown("---")
