...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["📚 PDF", "📃 Word", "📊 Powerpoint", "🌍 Website", "📺 Youtube", "✍️ Free text"])
...
with tab4:
    ...
    if web_input:
        st.success(f"✔️ You selected: **{web_input}**")
    st.markdown("---")
    ...
    messge_type_input = st.radio("*Note: Choose only one style; if unsure, you can read the instructions first.*",
                                   ('Bullet Points', 'Paragraph'), key='message_type_4')
    ...
    # Process
    if st.button("🤹 Press once and wait!", key='done_4'):
        st.text("Processing your selections... Please wait.")
        progress_bar = st.progress(0)
        for percent_complete in range(100):
            time.sleep(0.1)
...
with tab5:
    ...
    if yt_input:
        st.success(f"✔️ You selected: **{yt_input}**")
    st.markdown("---")
    ...
    messge_type_input = st.radio("*Note: Choose only one style; if unsure, you can read the instructions first.*",
                                   ('Bullet Points', 'Paragraph'), key='message_type_5')
    ...
    # Process
    if st.button("🤹 Press once and wait!", key='done_5'):
        st.text("Processing your selections... Please wait.")
        progress_bar = st.progress(0)
        for percent_complete in range(100):
            time.sleep(0.1)
...
with tab6:
    ...
    messge_type_input = st.radio("*Note: Choose only one style; if unsure, you can read the instructions first.*",
                                   ('Bullet Points', 'Paragraph'), key='message_type_6')
    ...
    # Process
    if st.button("🤹 Press once and wait!", key='done_6'):
        st.text("Processing your selections... Please wait.")
        progress_bar = st.progress(0)
        for percent_complete in range(100):
            time.sleep(0.1)
